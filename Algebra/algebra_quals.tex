...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{solution}
			As this is a finite extension of $\rationals$ and since any such extension is separable as $\rationals$ is perfect, the primitive element theorem guarantees the existence of such an $\alpha$.
		\end{solution}
